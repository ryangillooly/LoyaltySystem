...
public class UserEmailTokenConvertor : JsonConverter
{
    public override bool CanConvert(Type objectType) => objectType == typeof(UserEmailToken);
    ...
    {
        if (value is UserEmailToken emailToken)
        {
            var obj = new JObject
            {
